...
>
> If you are using `stellar-sdk`/`stellar-base` in a browser you can ignore this. However, for production backend deployments you should definitely be using `ed25519`. If `ed25519` is succstellarfully installed and working `stellarSdk.FastSigning` variable will be equal `true`. Otherwise it will be `false`.
