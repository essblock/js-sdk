 ...
 *
 * `Account` represents a single account in Ess network and its sequence number.
 * Account tracks the sequence number as it is used by {@link TransactionBuilder}.
 * accounts work in Ess.
 * @constructor
...
export class Account {
  ...
  /**
   * Returns Ess account ID, ex. `GB3KJPLFUYN5VL6R3GU3EGCGVCKFDSD7BEDX42HWG5BWFKB3KQGJJRMA`
   * @returns {string}
   */
  accountId() {
