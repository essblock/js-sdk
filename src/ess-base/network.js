 ...
 * * `Networks.PUBLIC`: `Public Global Ess Network ; September 2015`
 * * `Networks.TESTNET`: `Test SDF Network ; September 2015`
 * @type {{PUBLIC: string, TESTNET: string}}
 */
export const Networks = {
	PUBLIC: "Public Global Ess Network ; September 2015",
 ...
 * ess networks.  It also provides the {@link Network.current} class method that returns the network
