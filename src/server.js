...
export class Server {
    ...
    /**
     * People on the Ess network can make offers to buy or sell assets. This endpoint represents all the offers a particular account makes.
    ...
    /**
     * The Ess Network allows payments to be made between assets through path payments. A path payment specifies a
